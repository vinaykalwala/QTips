...
class CartItem(models.Model):
    ...
    model_name = models.CharField(max_length=120,default='Model name')
    brand_name = models.CharField(max_length=50, default='default_brand_value')
    tag_name = models.CharField(max_length=50,default='Tag name')
    ...
    def save(self, *args, **kwargs):
        ...
        self.packing_cost = self.variant.product.price
        self.tax = self.variant.product.tax
        self.model_name = self.variant.product.model_name
        self.brand_name = self.variant.product.brand.Brand_name if self.variant.product.brand else 'default_brand_value'
